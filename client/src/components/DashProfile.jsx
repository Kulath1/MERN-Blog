...
export default function DashProfile(){
    ...
    // a piece of state that creates the modal popup window
    ...
    return (
        <div className='max-w-lg mx-auto w-full'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                {/*if the user is the admin add 'create a post' button and link it */}
                {currentUser.isAdmin && (
                    <Link to={'/create-post'}>
                    <Button 
                        type='button' 
                ...
                {/*if the user is the admin add 'create an ad' button and link it */}
                {currentUser.isAdmin && (
                    <Link to={'/create-ad'}>
                    <Button 
                        type='button' 
            ...
            {/* if there's a problem with the modal window, show an error */}
            {error && (
                <Alert color='failure' className='mt-5'>
                    {error}
                </Alert>
...
//First make the api route
//Add an event listener to do sth with the buttons
//To add that event, we call a function
//Create slices or reducers
//After that, create a request to the particular API route and do the function that we wanna do